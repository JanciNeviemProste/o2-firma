      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Máte otázku alebo záujem o spoluprácu? Napíšte nám a ozveme sa vám
            do 24 hodín.
          </p>
        </div>
          ...
          <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-8">
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full text-center py-12">
                ...
                <p className="text-gray-400">Ďakujeme! Ozveme sa vám čo najskôr.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-gray-800 border border-gray-700 text-gray-100 rounded-lg px-4 py-3 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-500"
                    placeholder="Záujem o rekonštrukciu"
                  />
                </div>
                <div>
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-500 text-white py-3 rounded-lg font-semibold shadow-md transition-all duration-300 hover:bg-blue-400 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-950"
                >
                  Odoslať správu
                </button>
              </form>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-8">
              ...
              <ul className="flex flex-col gap-3 text-gray-400">
                ...
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-blue-500 rounded-full shrink-0" />
                  Kvalitné materiály a overení dodávatelia
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-blue-500 rounded-full shrink-0" />
